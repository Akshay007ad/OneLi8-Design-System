...
export const tokens = {
  ...
  "material.gem.color.quiet.stabilizedFace": {
    ...
    "description": "Quiet Light Gem stabilized content plane. 0.15, because it is not seen alone: the filled Gem field stacks the Control Gem Secondary gradient on top of it, and 0.15 under that ladder composites to 0.18-0.23 white — the same presence as the 0.18 environmental face, which is the transparency that was approved. At the previous 0.27 the composite was 0.31-0.43 and the surface read as milk. The Gem families keep their own stabilized alphas (sapphire 0.30 and so on); this one no longer tracks them, because they are not stacked under a second layer.",
    "tier": "semantic"
  },
