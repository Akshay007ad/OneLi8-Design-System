...
ok(manifest.counts.primitive===170&&manifest.counts.semantic===270&&manifest.counts.component===160&&manifest.counts.componentStatuses===10&&manifest.counts.figmaVariables===586&&manifest.counts.figmaElevationStyles===5,"Navigation spacing and contextual token output counts must remain deterministic");
